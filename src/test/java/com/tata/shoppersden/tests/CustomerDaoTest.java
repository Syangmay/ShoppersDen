...
public class CustomerDaoTest {
    ...
    @Test
    @DisplayName("Product and Customer Should not be null")
    public void testProductAndCustomer()
    {
        assertThrows(NullPointerException.class,()-> customerDao.addToCart(product,customer));
    }
